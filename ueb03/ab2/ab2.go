...
/*
	...
	Konsole darzustellen. Dabei werden für
	jede Schachfigur Konstanten definiert, die stellvertretend
	für diese Figuren stehen. Die Konstanten sind als
	uint64 Werte hinterlegt, die eine Art "Code" oder
	Identifikation für jede Figur darstellen:
	...
	* PAWN für Bauer
	...
	ein Schachbrett zu generieren, auf dem jede Figur
	an ihrer Startposition angezeigt wird. Die Ausgabe
	erfolgt textuell in der Konsole, sodass man das Schachfeld
	mit seinen Figuren visuell erkennen kann.
	-------------------------------------------
	...
	BONUS: Speichere Schachfeld im Array
*/
const (
	KNIGHT uint64 = (1 << 1) | (1 << 6)
	ROOK   uint64 = (1 << 0) | (1 << 7)
